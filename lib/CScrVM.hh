...
class CNativeManager
{
    ...
    static void StoreParams(CScriptParams* params, Args... args)
    {
        Pack(params, args...);
    }
...
public:
    ...
    template<typename ... Args>
    static void CallNativeRet(void* ret, const std::string &name, Args ... args)
    {
        NativeData data;
    ...
    template<typename ... Args>
    static void CallNative(const std::string &name, Args ... args)
    {
